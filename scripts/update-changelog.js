...
const prompt = [
  ...
  "- Prefer concrete product behavior over internal implementation details.",
  "- If commits describe a user-visible feature, bug fix, UI change, workflow change, or release tooling change, include it explicitly.",
  "- Only use a fallback summary like 'No user-facing changes since ...' when the commit range truly has no meaningful user-visible or release-visible changes.",
  "- Do not output a placeholder 'no user-facing changes' entry if any commit suggests an actual feature or behavior change.",
